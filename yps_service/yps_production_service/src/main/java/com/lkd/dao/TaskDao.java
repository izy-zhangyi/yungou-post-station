...
public interface TaskDao extends BaseMapper<TaskEntity> {
    ...
    @Results(id = "taskMap",value = {
            ...
            @Result(column = "product_type_id",property = "taskType",one = @One(select = "com.yps.dao.TaskTypeDao.selectById")),
            @Result(column = "task_status",property = "taskStatus"),
            @Result(column = "task_status",property = "taskStatusTypeEntity",one = @One(select = "com.yps.dao.TaskStatusTypeDao.selectById"))
    })

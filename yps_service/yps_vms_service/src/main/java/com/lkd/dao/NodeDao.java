...
public interface NodeDao extends BaseMapper<NodeEntity> {
    @Results(id = "nodeMap",value = {
            ...
            @Result(property = "area",column = "area_id",one=@One(select = "com.yps.dao.AreaDao.selectById")),
            @Result(property = "vmCount",column = "id",many = @Many(select = "com.yps.dao.VendingMachineDao.getCountByNodeId")),
            @Result(property = "regionId",column = "region_id"),
            @Result(property = "region",column = "region_id",one = @One(select = "com.yps.dao.RegionDao.selectById")),
            @Result(property = "businessId",column = "business_id"),
            @Result(property = "businessType",column = "business_id",one = @One(select = "com.yps.dao.BusinessTypeDao.selectById"))
    })
